...
public class UiBinderWriter implements Statements {
  ...
  public JClassType findFieldType(XMLElement elem) throws UnableToCompleteException {
    ...
    if (SVGConstants.SVG_NAMESPACE_URI.equals(uri)) {
    	return findSvgDomElementTypeForTag(tagName);
    }
    // laaglu
  ...
  // laaglu
  /**
   * Given a SVG tag name, return the corresponding
   * {@link org.vectomatic.dom.svg.OMSVGElement} subclass.
   */
