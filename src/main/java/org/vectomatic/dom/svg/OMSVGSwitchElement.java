...
/**
 * The {@link org.vectomatic.dom.svg.OMSVGSwitchElement} interface corresponds
 * to the <a href='http://www.w3.org/TR/SVG11/struct.html#SwitchElement' title='switch
 * element specification'>switch</a> element.
 */
@TagName("switch")
public class OMSVGSwitchElement extends OMSVGElement implements HasGraphicalHandlers, ISVGTests, ISVGLangSpace, ISVGExternalResourcesRequired, ISVGStylable, ISVGTransformable, ISVGContainerElement {
  public OMSVGSwitchElement() {
    this((SVGSwitchElement)DOMHelper.createElementNS(DOMHelper.getCurrentDocument(), SVGConstants.SVG_NAMESPACE_URI, SVGConstants.SVG_SWITCH_TAG).cast());
  }

  protected OMSVGSwitchElement(SVGSwitchElement ot) {
    super(ot);
  }
  ...
  public final OMSVGAnimatedBoolean getExternalResourcesRequired() {
    return ((SVGSwitchElement)ot).getExternalResourcesRequired();
  }
  ...
  public final String getXmllang() {
    return ((SVGSwitchElement)ot).getXmllang();
  }
  /**
   * Corresponds to attribute <code>xml:lang</code> on the given element.
  ...
  public final void setXmllang(java.lang.String value) throws JavaScriptException {
    ((SVGSwitchElement)ot).setXmllang(value);
  }
  /**
   * Corresponds to attribute <code>xml:space</code> on the given element.
   */
  public final String getXmlspace() {
    return ((SVGSwitchElement)ot).getXmlspace();
  }
  /**
   * Corresponds to attribute <code>xml:space</code> on the given element.
   * @throws DOMException(NO_MODIFICATION_ALLOWED_ERR) Raised on an   attempt
  ...
  public final void setXmlspace(java.lang.String value) throws JavaScriptException {
    ((SVGSwitchElement)ot).setXmlspace(value);
  }
  ...
  public final OMSVGElement getNearestViewportElement() {
    return (OMSVGElement)convert(((SVGSwitchElement)ot).getNearestViewportElement());
  }
  /**
  ...
  public final OMSVGElement getFarthestViewportElement() {
    return (OMSVGElement)convert(((SVGSwitchElement)ot).getFarthestViewportElement());
  }
  /**
  ...
  public final OMSVGRect getBBox() {
    return ((SVGSwitchElement)ot).getBBox();
  }
  /**
  ...
  public final OMSVGMatrix getCTM() {
    return ((SVGSwitchElement)ot).getCTM();
  }
  /**
   * Returns the transformation matrix from current user units (i.e., after
  ...
  public final OMSVGMatrix getScreenCTM() {
    return ((SVGSwitchElement)ot).getScreenCTM();
  }
  /**
  ...
  public final OMSVGMatrix getTransformToElement(OMSVGElement element) throws JavaScriptException {
    return ((SVGSwitchElement)ot).getTransformToElement(((SVGElement)element.ot));
  }
  ...
  public final OMSVGStringList getRequiredFeatures() {
    return ((SVGSwitchElement)ot).getRequiredFeatures();
  }
  /**
  ...
  public final OMSVGStringList getRequiredExtensions() {
    return ((SVGSwitchElement)ot).getRequiredExtensions();
  }
  /**
  ...
  public final OMSVGStringList getSystemLanguage() {
    return ((SVGSwitchElement)ot).getSystemLanguage();
  }
  /**
  ...
  public final boolean hasExtension(String extension) {
    return ((SVGSwitchElement)ot).hasExtension(extension);
  }
  ...
  public final OMSVGAnimatedTransformList getTransform() {
    return ((SVGSwitchElement)ot).getTransform();
  }
