...
public class OMSVGPathSegCurvetoCubicAbs extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegCurvetoCubicAbs() {
  }

  // Implementation of the nsIDOMSVGPathSegCurvetoCubicAbs XPCOM interface
