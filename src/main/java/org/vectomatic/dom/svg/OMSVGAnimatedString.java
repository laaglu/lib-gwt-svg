 ...
 */
public class OMSVGAnimatedString extends JavaScriptObject {
   ...
   * attribute</a>.
   */
  public final native void setBaseVal(String value) throws JavaScriptException /*-{
    this.baseVal = value;
  }-*/;
  /**
   ...
   * org.vectomatic.dom.svg.OMSVGAnimatedString#getBaseVal()}.
   */
