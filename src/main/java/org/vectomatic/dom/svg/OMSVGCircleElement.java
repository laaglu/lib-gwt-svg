...
/**
 * The {@link org.vectomatic.dom.svg.OMSVGCircleElement} interface corresponds
 * to the <a href='http://www.w3.org/TR/SVG11/shapes.html#CircleElement' title='circle
 * element specification'>circle</a> element.
 */
@TagName("circle")
public class OMSVGCircleElement extends OMSVGElement implements HasGraphicalHandlers, ISVGTests, ISVGLangSpace, ISVGExternalResourcesRequired, ISVGStylable, ISVGTransformable, ISVGGraphicsElement {
  public OMSVGCircleElement() {
    this((SVGCircleElement)DOMHelper.createElementNS(DOMHelper.getCurrentDocument(), SVGConstants.SVG_NAMESPACE_URI, SVGConstants.SVG_CIRCLE_TAG).cast());
  }
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGCircleElement#getCx()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#CircleElement'
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGCircleElement#getCy()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#CircleElement'
   * title='circle element specification'>circle</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGCircleElement#getR()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#CircleElement'
   * title='circle element specification'>circle</a> element.
   */
  ...
  public final OMSVGElement getNearestViewportElement() {
    SVGElement elt = ((SVGCircleElement)ot).getNearestViewportElement();
  ...
  public final OMSVGElement getFarthestViewportElement() {
    SVGElement elt = ((SVGCircleElement)ot).getFarthestViewportElement();
    return elt != null ? (OMSVGElement)convert(elt) : null;
  }
  /**
