...
/**
 * The {@link org.vectomatic.dom.svg.OMSVGDefsElement} interface corresponds
 * to the <a href='http://www.w3.org/TR/SVG11/struct.html#DefsElement' title='defs
 * element specification'>defs</a> element.
 */
@TagName("defs")
public class OMSVGDefsElement extends OMSVGElement implements HasGraphicalHandlers, ISVGTests, ISVGLangSpace, ISVGExternalResourcesRequired, ISVGStylable, ISVGTransformable, ISVGContainerElement {
  public OMSVGDefsElement() {
    this((SVGDefsElement)DOMHelper.createElementNS(DOMHelper.getCurrentDocument(), SVGConstants.SVG_NAMESPACE_URI, SVGConstants.SVG_DEFS_TAG).cast());
  }
  ...
  public final OMSVGElement getNearestViewportElement() {
    SVGElement elt = ((SVGDefsElement)ot).getNearestViewportElement();
  ...
  public final OMSVGElement getFarthestViewportElement() {
    SVGElement elt = ((SVGDefsElement)ot).getFarthestViewportElement();
    return elt != null ? (OMSVGElement)convert(elt) : null;
  }
  /**
