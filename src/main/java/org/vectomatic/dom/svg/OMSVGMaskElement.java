...
public class OMSVGMaskElement extends org.vectomatic.dom.svg.OMSVGElement {
  protected OMSVGMaskElement() {
  }

  // Implementation of the nsIDOMSVGMaskElement XPCOM interface
  public final native org.vectomatic.dom.svg.OMSVGAnimatedEnumeration getMaskUnits() /*-{
    return this.maskUnits;
  }-*/;
  public final native org.vectomatic.dom.svg.OMSVGAnimatedEnumeration getMaskContentUnits() /*-{
