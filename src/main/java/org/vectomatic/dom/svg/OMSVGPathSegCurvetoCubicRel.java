...
public class OMSVGPathSegCurvetoCubicRel extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegCurvetoCubicRel() {
  }

  // Implementation of the nsIDOMSVGPathSegCurvetoCubicRel XPCOM interface
