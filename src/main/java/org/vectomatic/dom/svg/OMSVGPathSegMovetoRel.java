...
public class OMSVGPathSegMovetoRel extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegMovetoRel() {
  }

  // Implementation of the nsIDOMSVGPathSegMovetoRel XPCOM interface
