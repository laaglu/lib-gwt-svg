...
import org.vectomatic.dom.svg.OMSVGAnimatedTransformList;
  ...
  /**
   * Interface {@link org.vectomatic.dom.svg.itf.ISVGTransformable} contains
   * properties and methods that apply to all elements which have attribute
   * {@link org.vectomatic.dom.svg.itf.ISVGTransformable#getTransform()}.
   */
public interface ISVGTransformable extends ISVGLocatable {
   ...
   */
  public OMSVGAnimatedTransformList getTransform();
}
