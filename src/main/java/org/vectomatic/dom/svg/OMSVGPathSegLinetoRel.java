...
public class OMSVGPathSegLinetoRel extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegLinetoRel() {
  }

  // Implementation of the nsIDOMSVGPathSegLinetoRel XPCOM interface
