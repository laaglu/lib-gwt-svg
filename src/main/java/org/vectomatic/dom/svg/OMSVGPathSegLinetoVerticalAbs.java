...
public class OMSVGPathSegLinetoVerticalAbs extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegLinetoVerticalAbs() {
  }

  // Implementation of the nsIDOMSVGPathSegLinetoVerticalAbs XPCOM interface
