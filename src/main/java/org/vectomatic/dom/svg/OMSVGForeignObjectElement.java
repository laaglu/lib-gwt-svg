...
public class OMSVGForeignObjectElement extends org.vectomatic.dom.svg.OMSVGElement {
  protected OMSVGForeignObjectElement() {
  }

  // Implementation of the nsIDOMSVGForeignObjectElement XPCOM interface
