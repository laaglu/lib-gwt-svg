...
/**
 * The {@link org.vectomatic.dom.svg.OMSVGEllipseElement} interface corresponds
 * to the <a href='http://www.w3.org/TR/SVG11/shapes.html#EllipseElement'
 * title='ellipse element specification'>ellipse</a> element.
 */
@TagName("ellipse")
public class OMSVGEllipseElement extends OMSVGElement implements HasGraphicalHandlers, ISVGTests, ISVGLangSpace, ISVGExternalResourcesRequired, ISVGStylable, ISVGTransformable, ISVGGraphicsElement {
  public OMSVGEllipseElement() {
    this((SVGEllipseElement)DOMHelper.createElementNS(DOMHelper.getCurrentDocument(), SVGConstants.SVG_NAMESPACE_URI, SVGConstants.SVG_ELLIPSE_TAG).cast());
  }
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGEllipseElement#getCx()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#EllipseElement'
   * title='ellipse element specification'>ellipse</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGEllipseElement#getCy()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#EllipseElement'
   * title='ellipse element specification'>ellipse</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGEllipseElement#getRx()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#EllipseElement'
   * title='ellipse element specification'>ellipse</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.OMSVGEllipseElement#getRy()}
   * on the given <a href='http://www.w3.org/TR/SVG11/shapes.html#EllipseElement'
   * title='ellipse element specification'>ellipse</a> element.
   */
  ...
  public final OMSVGElement getNearestViewportElement() {
    SVGElement elt = ((SVGEllipseElement)ot).getNearestViewportElement();
  ...
  public final OMSVGElement getFarthestViewportElement() {
    SVGElement elt = ((SVGEllipseElement)ot).getFarthestViewportElement();
    return elt != null ? (OMSVGElement)convert(elt) : null;
  }
  /**
