...
public class OMSVGUseElement extends org.vectomatic.dom.svg.OMSVGElement {
  protected OMSVGUseElement() {
  }

  // Implementation of the nsIDOMSVGUseElement XPCOM interface
