...
/**
 * The {@link org.vectomatic.dom.svg.OMSVGSVGElement} interface corresponds
 * to the <a href='http://www.w3.org/TR/SVG11/struct.html#GElement' title='g
 * element specification'>g</a> element.
 */
@TagName("g")
public class OMSVGGElement extends OMSVGElement implements HasGraphicalHandlers, ISVGTests, ISVGLangSpace, ISVGExternalResourcesRequired, ISVGStylable, ISVGTransformable, ISVGContainerElement {
  public OMSVGGElement() {
    this((SVGGElement)DOMHelper.createElementNS(DOMHelper.getCurrentDocument(), SVGConstants.SVG_NAMESPACE_URI, SVGConstants.SVG_G_TAG).cast());
  }
  ...
  public final OMSVGAnimatedBoolean getExternalResourcesRequired() {
    return ((SVGGElement)ot).getExternalResourcesRequired();
  }
  ...
  public final String getXmllang() {
    return ((SVGGElement)ot).getXmllang();
  }
  /**
   * Corresponds to attribute <code>xml:lang</code> on the given element.
  ...
  public final void setXmlspace(java.lang.String value) throws JavaScriptException {
    ((SVGGElement)ot).setXmlspace(value);
  }
  ...
  public final OMSVGElement getNearestViewportElement() {
    return (OMSVGElement)convert(((SVGGElement)ot).getNearestViewportElement());
  }
  /**
  ...
  public final OMSVGElement getFarthestViewportElement() {
    return (OMSVGElement)convert(((SVGGElement)ot).getFarthestViewportElement());
  }
  /**
  ...
  public final OMSVGMatrix getScreenCTM() {
    return ((SVGGElement)ot).getScreenCTM();
  }
  /**
  ...
  public final OMSVGMatrix getTransformToElement(OMSVGElement element) throws JavaScriptException {
    return ((SVGGElement)ot).getTransformToElement(((SVGElement)element.ot));
  }
  ...
  public final OMSVGStringList getRequiredFeatures() {
    return ((SVGGElement)ot).getRequiredFeatures();
  }
  /**
  ...
  public final OMSVGStringList getRequiredExtensions() {
    return ((SVGGElement)ot).getRequiredExtensions();
  }
  /**
  ...
  public final OMSVGStringList getSystemLanguage() {
    return ((SVGGElement)ot).getSystemLanguage();
  }
  /**
  ...
  public final boolean hasExtension(String extension) {
    return ((SVGGElement)ot).hasExtension(extension);
  }
  ...
  public final OMSVGAnimatedTransformList getTransform() {
    return ((SVGGElement)ot).getTransform();
  }
