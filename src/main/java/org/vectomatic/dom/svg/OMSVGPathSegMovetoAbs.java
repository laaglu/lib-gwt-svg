...
public class OMSVGPathSegMovetoAbs extends com.google.gwt.core.client.JavaScriptObject {
  protected OMSVGPathSegMovetoAbs() {
  }

  // Implementation of the nsIDOMSVGPathSegMovetoAbs XPCOM interface
