...
public class NamedNodeMap<T extends Node> extends JavaScriptObject {
     ...
     *   Entities.
     */
	public final native T setNamedItem(Node arg) throws JavaScriptException /*-{
     ...
     *   <br>NO_MODIFICATION_ALLOWED_ERR: Raised if this map is readonly.
     */
	public final native T removeNamedItem(String name) throws JavaScriptException /*-{
     ...
     */
	public final native T getNamedItemNS(String namespaceURI, String localName) throws JavaScriptException /*-{
     ...
     *   Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]). 
     */
	public final native T setNamedItemNS(Node arg) throws JavaScriptException /*-{
	   return this.setNamedItem(arg);
	}-*/;
     ...
     *   Document does not support XML Namespaces (such as [<a href='http://www.w3.org/TR/1999/REC-html401-19991224/'>HTML 4.01</a>]). 
     */
	public final native T removeNamedItemNS(String namespaceURI, String localName) throws JavaScriptException /*-{
