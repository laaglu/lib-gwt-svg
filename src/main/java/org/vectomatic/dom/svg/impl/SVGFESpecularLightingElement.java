...
/**
 * The {@link org.vectomatic.dom.svg.impl.SVGFESpecularLightingElement} interface
...
public class SVGFESpecularLightingElement extends SVGElement {
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGFESpecularLightingElement#getSurfaceScale()}
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGFESpecularLightingElement#getSpecularConstant()}
   * on the given <a href='http://www.w3.org/TR/SVG11/filters.html#feSpecularLightingElement'
   * title='feSpecularLighting element specification'>feSpecularLighting</a>
   * element.
   */
  public final native OMSVGAnimatedNumber getSpecularConstant() /*-{
    return this.specularConstant;
  }-*/;
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGFESpecularLightingElement#getSpecularExponent()}
   * on the given <a href='http://www.w3.org/TR/SVG11/filters.html#feSpecularLightingElement'
   * title='feSpecularLighting element specification'>feSpecularLighting</a>
   * element.
   */
