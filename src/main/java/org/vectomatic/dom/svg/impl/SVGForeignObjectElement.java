...
/**
 * The {@link org.vectomatic.dom.svg.impl.SVGForeignObjectElement} interface
...
public class SVGForeignObjectElement extends SVGElement {
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGForeignObjectElement#getX()}
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGForeignObjectElement#getY()}
   * on the given <a href='http://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement'
   * title='foreignObject element specification'>foreignObject</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGForeignObjectElement#getWidth()}
   * on the given <a href='http://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement'
   * title='foreignObject element specification'>foreignObject</a> element.
   */
  ...
  /**
   * Corresponds to attribute {@link org.vectomatic.dom.svg.impl.SVGForeignObjectElement#getHeight()}
   * on the given <a href='http://www.w3.org/TR/SVG11/extend.html#ForeignObjectElement'
   * title='foreignObject element specification'>foreignObject</a> element.
   */
