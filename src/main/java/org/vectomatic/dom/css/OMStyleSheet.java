...
public class OMStyleSheet extends org.vectomatic.dom.stylesheets.OMStyleSheet {
  protected OMStyleSheet() {
  }

  // Implementation of the nsIDOMCSSStyleSheet XPCOM interface
  public final native org.vectomatic.dom.css.OMRule getOwnerRule() /*-{
